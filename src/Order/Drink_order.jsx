...
const Dri = () => {
    ...
    useEffect(() => {
        async function fetchDrink() {
          try {
            const response = await fetch(`http://localhost:5000/api/drink/${id}`);
            if (!response.ok) {
    ...
    <>
        ...
        <div class="heading-title text-center">
            ...
            <div class="f-row">
                <div>
                    <div>
                        <img src={drink?.image} alt='' width={500} className="border-radius: 30px;"/>
                    </div>
                    ...
                    <div>
                        ...
                        <tr>
                                <td><h3 class="text-left">{drink?.name}</h3></td>
                                <h3 class="text-right">₹ {drink?.price}</h3>
                        </tr>    
                        <br></br>   
                        <h4>{drink?.tag}</h4>
