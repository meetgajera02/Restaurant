...
const Fast = () => {
    ...
    useEffect(() => {
        async function fetchFastfood() {
          try {
            const response = await fetch(`http://localhost:5000/api/fastfood/${id}`);
            if (!response.ok) {
    ...
    <>
        ...
        <div class="heading-title text-center">
            ...
            <div class="f-row">
                <div>
                    <div>
                        <img src={fastfood?.image} alt='' width={500} className="border-radius: 30px;"/>
                    </div>
                    ...
                    <div>
                        ...
                        <tr>
                                <td><h3 class="text-left">{fastfood?.name}</h3></td>
                                <h3 class="text-right">₹ {fastfood?.price}</h3>
                        </tr>    
                        <br></br>   
                        <h4>{fastfood?.tag}</h4>
